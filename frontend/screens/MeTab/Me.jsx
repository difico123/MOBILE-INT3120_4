import { View, Text, Image, StyleSheet, TouchableOpacity, Button, SafeAreaView, ScrollView, StatusBar } from "react-native";
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
              ...
              <Icon style={styles.camera} name="camera"/>
                    ...
                    <View style={styles.main}>
                        ...
                        <TouchableOpacity style={styles.content} onPress={goRoom}>
                    ...
                    <View style={styles.buttonBox}>
                        <Button onPress={onSignOut} title="Sign Out" style={styles.buttonSignout} />
                    </View>
