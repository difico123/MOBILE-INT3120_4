...
import { initSocket, disconnectSocket, joinRoom, messageSocket, sendMessage } from "../../service/socket";
        ...
        <View style={container}>
            <View style={styles.chatWrap}>
                <FlatList
                    ...
                    renderItem={({ item, index }) => <ChatItem chat={item.text} image={item.image} name={item.name} me={item.me} />}
                />
            </View>
            ...
            <View style={styles.bottomTab}>
                ...
                <View style={styles.input}>
                    <TextInput placeholder="Nhắn tin" value={chat} onChangeText={setChat} />
                </View>
