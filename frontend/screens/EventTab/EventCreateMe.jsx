...
const EventCreateMe = ({ navigation }) => {
  ...
  const onChangePicker = (itemValue, itemIndex) => {
    ...
    if (itemValue === dataPicker.all) {
      ...
      activeEventList = events.filter((event) =>
        itemValue === dataPicker.active ? event.status : !event.status
      );
    }
      ...
      >
        <View style={styles.wrap}>
          ...
          <View style={styles.plusWrap}>
            ...
            >
              <Picker.Item
                label={dataPicker.all}
                value={dataPicker.all}
                disabled={true}
              />
              <Picker.Item
                label={dataPicker.active}
                value={dataPicker.active}
              />
              <Picker.Item
                label={dataPicker.inActive}
                value={dataPicker.inActive}
              />
            </Picker>
          </View>
        </View>
