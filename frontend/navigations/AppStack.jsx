  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        name="Profile"
        component={Profile}
        options={option("Thông tin cá nhân")}
      />
      <Stack.Screen
        name="Change Password"
        component={PasswordChange}
        options={option("Thay đổi mật khẩu")}
      />
      <Stack.Screen
        name="Change Information"
        component={InfoChange}
        options={option("Thay đổi thông tin")}
      />
      <Stack.Screen
        name="MapScreen"
        component={MapScreen}
        options={option("Bản đồ")}
      />
      <Stack.Screen
        name="EventCreateMe"
        component={EventCreateMe}
        options={option("Danh sách sự kiện")}
      />
      <Stack.Screen
        name="EventCreate"
        component={EventCreate}
        options={option("Sự kiện mới")}
      />
      {/* <Stack.Screen name="Friend" component={Friend} options={option("Bạn bè")} /> */}
      <Stack.Screen
        name="EventInfo"
        component={EventInfo}
        options={option("Thông tin sự kiện")}
      />
      <Stack.Screen name="ChatRoom" component={ChatRoom} options={option("")} />
      <Stack.Screen
        name="Rooms"
        component={Rooms}
        options={option("Phòng chat")}
      />
      <Stack.Screen
        name="InviteFriend"
        component={InviteFriend}
        options={option("Mời bạn")}
      />
      <Stack.Screen
        name="Attendance"
        component={Attendance}
        options={option("Danh sách người tham dự")}
      />
      <Stack.Screen
        name="Email"
        component={MailTemplate}
        options={option("Gửi email")}
      />
      <Stack.Screen
        name="JoinedEvent"
        component={JoinedEvent}
        options={option("Sự kiện đã tham gia")}
      />
      <Stack.Screen
        name="RequestEvent"
        component={RequestEvent}
        options={option("Sự kiện được mời tham dự")}
      />
    </Stack.Navigator>
  );
};
